                    ...
                    <div class="col-md-8">
                        <form>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="桃太郎">
                            </div>
                            <div class="form-group">
                                <label for="exampleFormControlTextarea1">いつ</label>
                                <textarea class="form-control" name="when" placeholder="むかしむかし" rows="2"></textarea>
                            </div>
                            <div class="form-group">
                                <label for="exampleFormControlTextarea1">どこで</label>
                                <textarea class="form-control" name="where" placeholder="あるところで" rows="2"></textarea>
                            </div>

                            <div class="form-group">
                                <label for="exampleFormControlTextarea1">誰が</label>
                                <textarea class="form-control" name="who" placeholder="おじいさんとおばあさんが" rows="2"></textarea>
                            </div>

                            <div class="form-group">
                                <label for="exampleFormControlTextarea1">何をした</label>
                                <textarea class="form-control" name="what" placeholder="暮らしていた" rows="2"></textarea>
                            </div>

                            <div class="form-group">
                                <label for="exampleFormControlTextarea1">どうして</label>
                                <textarea class="form-control" name="why" placeholder="お金がそんなにないので" rows="2"></textarea>
                            </div>
                            <div class="form-group">
                                <label for="exampleFormControlTextarea1">どのように</label>
                                <textarea class="form-control" name="how" placeholder="慎ましく" rows="2"></textarea>
                            </div>
                        ...
                        <a href="comp.html" class="btn btn-outline-primary btn-block">登録</a>
