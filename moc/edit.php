                    ...
                    <div class="col-md-8">
                        <form>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="who" rows="2">おじいさんとおばあさんが</textarea>
                            </div>

                            <div class="form-group">
                                <label for="exampleFormControlTextarea1">何をした</label>
                                <textarea class="form-control" name="what" rows="2">暮らしていた</textarea>
                            </div>

                            <div class="form-group">
                                <label for="exampleFormControlTextarea1">どうして</label>
                                <textarea class="form-control" name="why" rows="2">お金がそんなにないので</textarea>
                            </div>
                            <div class="form-group">
                                <label for="exampleFormControlTextarea1">どのように</label>
                                <textarea class="form-control" name="how"  rows="2">慎ましく</textarea>
                            </div>
